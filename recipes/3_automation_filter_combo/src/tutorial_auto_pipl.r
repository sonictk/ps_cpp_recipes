...
resource 'PiPL' ( TUTORIAL_AUTO_RESOURCE_ID, TUTORIAL_AUTO_PLUGINNAME, purgeable)
	{
		{
		Kind { Actions },
		Name { TUTORIAL_AUTO_PLUGINNAME },
		Category { "AdobeSDK" },
		Version { (latestActionsPlugInVersion << 16) | latestActionsPlugInSubVersion },

		Component { ComponentNumber, TUTORIAL_AUTO_PLUGINNAME },
		...
		HasTerminology
			{
			TUTORIAL_AUTO_CLASS_ID,
			TUTORIAL_AUTO_EVENT_ID,
			TUTORIAL_AUTO_RESOURCE_ID,
			TUTORIAL_AUTO_UUID
			},
...
//-------------------------------------------------------------------------------
resource 'aete' (TUTORIAL_AUTO_RESOURCE_ID, TUTORIAL_AUTO_PLUGINNAME " dictionary", purgeable)
	{
	1, 0, english, roman,					/* aete version and language specifiers */
		{
		TUTORIAL_AUTO_VENDORNAME,							/* vendor suite name */
		TUTORIAL_AUTO_PLUGINDESC,		/* optional description */
		TUTORIAL_AUTO_SUITE_ID,	/* suite ID */
		1,									/* suite code, must be 1 */
		1,									/* suite level, must be 1 */
			{								/* structure for automation */
			TUTORIAL_AUTO_PLUGINNAME,		/* name */
			TUTORIAL_AUTO_PLUGINDESC,		/* optional description */
			TUTORIAL_AUTO_CLASS_ID,		/* class ID, must be unique or Suite ID */
			TUTORIAL_AUTO_EVENT_ID,		/* event ID, must be unique */
